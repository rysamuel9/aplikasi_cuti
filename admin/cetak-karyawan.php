<?php
 ...
 $nama_file='Laporan'; //Beri nama file PDF hasil.
...
<html>
<head>
    <title>Aplikasi Cuti Karyawan Scola LMS</title>
    <style>
        *
        {
            margin:0;
...
<div id="wrapper">
    ...
    <table class="heading" style="width:100%;">
        ...
        <td> <center><p style="text-align:center; font-size: 14px; font-weight:bold;">Aplikasi Cuti Karyawan</p></center></td>
         ...
         <table>
         <tr>
        <td><td><p style="text-align:left; font-size: 12px; font-weight:bold;">Tanggal : <?php echo date("Y/m/d H:i:s") ?> </p></td></td>
        </tr>
         </table>
    ...
    <div id="content">
        ...
        <?php
            ...
            <tr>
                <td style="width:5%;"><b>Nik</b></td>
                <td style="width:15%;"><b>Tanggal Masuk</b></td>
                <td style="width:25%;"><b>Nama</b></td>
                <td style="width:15%;"><b>Kelamin</b></td>
                <td style="width:20%;"><b>Jabatan</b></td>
                <td style="width:10%;"><b>Departemen</b></td>
                <td style="width:10%;"><b>Sisa Cuti</b></td>
            </tr>
            <?php
            //$no=0;
            ...
            <tr>
                ...
                <td style="width:15%;" class="mono"><b><?php echo $data1['masuk_kerja']; ?></b></td>
                <td style="width:25%;" class="mono"><b><?php echo $data1['nama']; ?></b></td>
                <td style="width:15%;" class="mono"><b><center><?php echo $data1['jenkel']; ?></center></b></td>
