 <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="#">SCOLA LMS</a>
       ...
       <!-- <ul class="nav navbar-nav d-md-down-none">
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="<?php echo $_SESSION['gambar']; ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
        ...
        <!-- <button class="navbar-toggler aside-menu-toggler" type="button"><span class="fa fa-bars"></span></button> -->
