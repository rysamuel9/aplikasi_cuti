   ...
   <?php include "menu.php"; ?>
        ...
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Input Karyawan</a>
                </li>
            </ol>
...
<?php
            ...
            if(isset($_POST['input'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO karyawan (id, nik, masuk_kerja, nama, jenkel, email, jabatan, departemen, alamat, no_hp, sisa_cuti, password)
															VALUES('$rand','$nik','$masuk_kerja','$nama','$jenkel','$email','$jabatan','$departemen','$alamat','$no_hp','$sisa_cuti','$password')") or die(mysqli_error());
						if($insert){
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="sisa_cuti" name="sisa_cuti" class="form-control" placeholder="sisa_cuti" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
