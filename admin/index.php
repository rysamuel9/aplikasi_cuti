                ...
                <div class="animated fadeIn">
                    ...
                    ?>
                                <div class="card-body p-3 clearfix">
                                    ...
                                    <div class="text-muted text-uppercase font-weight-bold font-xs">Total Karyawan</div>
                                </div>
                                <div class="card-footer px-3 py-2">
                                    <a class="font-weight-bold font-xs btn-block text-muted" href="karyawan.php">Detail Karyawan<i class="fa fa-angle-right float-right font-lg"></i></a>
                                </div>
                            </div>
                        </div>
                        <!--/.col-->
