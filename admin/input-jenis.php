   ...
   <?php include "menu.php"; ?>
        ...
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="jenis.php">Variabel Cuti</a>
                </li>
                <li class="breadcrumb-item"><a href="#">Input Variabel Cuti</a>
                </li>
            </ol>
...
<?php
            ...
            if(isset($_POST['input'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM jenis_cuti WHERE jenis='$jenis'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO jenis_cuti (id, jenis)
															VALUES('$rand','$jenis')") or die(mysqli_error());
						if($insert){
                        ...
                        <div class="col-sm-5">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Input</strong> Variabel Cuti
                                </div>
                                <div class="card-body">
                                    <form action="input-jenis.php" method="post" enctype="multipart/form-data" name="input" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="jenis" name="jenis" class="form-control" placeholder="Variabel Cuti" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
