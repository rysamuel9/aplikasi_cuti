                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <label for="tanggal_cuti">Pilih tanggal cuti : </label> 
                                                    <input required type="date" name="tanggal_cuti" id="tanggal_cuti" title="Tanggal Cuti" min="<?php echo date('Y-m-d'); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <label for="tanggal_cuti">Pilih tanggal selesai cuti : </label> 
                                                    <input required type="date" name="tanggal_masuk" id="tanggal_masuk" title="Tanggal Selesai Cuti" min="<?php echo date('Y-m-d'); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
